...
public class Uploader {
  ...
  private String getFolder(String path) {
    ...
    System.out.println("Uploader getFolder path:"+path);
    return path;
  }
...
//
//    System.out.println("Uploader getPhysicalPath realPath:"+realPath);

    return System.getProperty("catalina.home") + "//webapps//"+path;
